...
## 2. 사용 기술 & 아키텍처
<img width="600" height="325" alt="skills" src="docs/img/skills.png" /> 사용 기술
<br><br>

<img width="600" height="350" alt="architecture" src="docs/img/architecture.png" /> 아키텍처
...
## 3. ERD
<img width="588" height="388" alt="erd" src="docs/img/erd.png" />

- [ERD 설계 및 근거](docs/erd/erd.md)
